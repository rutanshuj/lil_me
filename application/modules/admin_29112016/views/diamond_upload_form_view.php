      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <div class="col-xs-12">
					...
					<div style="float: left;padding-bottom: 10px;"><a href="<?php echo base_url('admin/bulk_certificate_image_upload');?>" class="btn btn-primary" id="bulk_certificate_image_upload_page"> Bulk Certificate Image Upload</a></div>
				</div>
            <div class="col-xs-12">
              <div class="box">
...
function submitForm1(name){
		   ...
		   $.ajax({
			...
			<a href="<?php echo base_url('admin/diamond_excel_uploader');?>" id="diamond_back" class="btn btn-primary" >Back</a>			
