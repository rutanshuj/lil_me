 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
          ...
          <div class="row">
		   <div class="col-xs-12">
            ...
            <div class="col-xs-12">
			  ...
			  <form role="form" action="<?php echo base_url('admin/sub_category/edit?id=').$sub_category_id;?>" method="post"  enctype="multipart/form-data">
		...
		?>
				...
				<div>
				<input value="<?php if(isset($subcategory_name)){echo $subcategory_name ;}?>" name="subcategory_name" id="subcategory_name">
				</div>
				...
				<?php if(count($category_list)!="0"){
						...
						foreach($category_list as $category_rows){
							$selected='';
							if($category_id==$category_rows->category_id){
								$selected='selected';
							}
				...
				?>		
                        ...
                        <option value="<?php echo $category_rows->category_id;?>" <?php echo $selected;?>><?php echo $category_rows->category_name;?></option>
				...
				<input type="submit" class="btn btn-primary" id="submit" name="submit" value="Update Sub-Category" >
				</div>
