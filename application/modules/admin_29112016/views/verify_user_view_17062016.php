          ...
          <div class="row"  >
            <div class="col-xs-12" >
              <div class="box" >
				...
				function reject_user(id,name,email){
					...
					swal({   title: "Are you sure to reject below user ?", 
					  ...
					  function(isConfirm){  
						  if (isConfirm) {  
							window.location = "<?php echo base_url('admin/verify_user/user_disable?id=');?>"+id+"&name="+name+"&email="+email+"&status=rejected";	
...
$(document).ready(function() {
	...
	<div >
               ...
               <input class="form-control inbox_size" type="text" id="pen_datepicker_<?php echo $limit_pen;?>" name="pen_datepicker_<?php echo $limit_pen;?>"value="<?php echo $pend_user_vali;?>">
						...
						<td>
						<input value="REJECT"  type="button"  class="btn btn-primary" onClick="return reject_user('<?php echo $pending_row->user_id;?>','<?php echo $pending_row->username;?>','<?php echo $pending_row->email_id;?>')" />
...
<div>
              ...
              <div class="box">
				...
				function disable_user(id,name,email){
					...
					swal({   title: "Are you sure to disable below user ?", 
					  ...
					  function(isConfirm){  
						  if (isConfirm) {  
							window.location = "<?php echo base_url('admin/verify_user/user_disable?id=');?>"+id+"&name="+name+"&email="+email+"&status=disabled";	
				...
				function active_user_update(date,user_type,user_id,email,username){
					if(date==''){
						alert("Please Add Validity");
	  ...
	  if (isConfirm) { 
		...
		swal("Cancelled", "You have cancelled :)", "error");  
                  ...
                  <input class="form-control inbox_size" type="text" id="a_u_datepicker_<?php echo $limit_act;?>" name="a_u_datepicker_<?php echo $limit_act;?>"value="<?php echo $active_user_vali;?>">
						...
						<input value="DISABLE"  type="button"  class="btn btn-primary" onClick="return disable_user('<?php echo $active_rows->user_id;?>','<?php echo $active_rows->username;?>','<?php echo $active_rows->email_id;?>')" />
						</td>
						<td>					
						
						
						<input value="UPDATE"  type="button"  class="btn btn-primary" onClick="return active_user_update(document.getElementById('a_u_datepicker_<?php echo $limit_act;?>').value,document.getElementById('user_type_<?php echo $limit_act;?>').value,'<?php echo $active_rows->user_id;?>','<?php echo $active_rows->email_id;?>','<?php echo $active_rows->username;?>')" />​
