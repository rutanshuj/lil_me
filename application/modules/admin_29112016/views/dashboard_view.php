		 ...
		 <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                ...
                <a href="<?php echo base_url('admin/catalogue');?>" class="small-box-footer">Catalogue </a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
				  ...
				  <div class="col-sm-12">
				   ...
				   <table id="example" class="table table-bordered table-striped" >
                    ...
                    <thead>
					  ...
					  <th class="select-filter" style="width: 20% !important;text-align: center;">Activity Detail</th>
					...
					<tr>
						...
						<th class="width_20_persent"style="text-align: center;">Activity Detail</th>
                    ...
                    <tbody>
					  ...
					  foreach($activity as $activity_row){
                        ...
                        <td  class="width_20_persent"><?php echo $activity_row->activity_detail;?></td>
