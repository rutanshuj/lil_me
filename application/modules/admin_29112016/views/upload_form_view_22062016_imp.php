      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <div class="col-xs-12">
					...
					<div style="padding-bottom: 10px;"><a href="<?php echo base_url('admin/jewellery_bulk_image_upload');?>" class="btn btn-primary" id="jewellery_bulk_image_upload_page"> Bulk Image Upload</a></div>
				</div>
            <div class="col-xs-12">
              <div class="box">
...
function submitForm1(name){
		   ...
		   $.ajax({
			...
			<a href="<?php echo base_url('admin/excel_uploader');?>"  class="btn btn-primary" >Back</a>			
