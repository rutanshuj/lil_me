      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
		   <div class="col-xs-12">
					...
					<a href="<?php echo base_url('admin/attribute');?>" class="btn btn-primary" style="border-style:groove solid double;border-color: black;border-width: 2px;border-radius: 6px">
            ...
            <div class="col-xs-12">
			  ...
			  <form role="form" action="<?php echo base_url('admin/attribute/edit?id=').$attribute_id;?>" method="post"  enctype="multipart/form-data">
		...
		?>
				...
				<?php foreach($master_attribute_type as $attribute_type_row) {
					...
					if(isset($attribute_type_id) && is_numeric($attribute_type_id) ){
						if(isset($attribute_type_id) && ($attribute_type_id==$attribute_type_row->attribute_type_id)){
							$selected ='selected';
						}
					} else if(isset($attribute_type_id) && !is_numeric($attribute_type_id) ){
						if(isset($attribute_type_id) && ($attribute_type_id==$attribute_type_row->attribute_type_title)){
							$selected ='selected';
						}
					}
					...
					?>
					<option value="<?php echo $attribute_type_row->attribute_type_title;?>" <?php echo $selected;?> ><?php echo $attribute_type_row->attribute_type_title;?></option>
				<?php
				}
				?>
				</select></div>
				...
				<?php foreach($master_attribute_header as $attribute_header_row) {
					...
					if(isset($attribute_header_id) && is_numeric($attribute_header_id) ){
						if(isset($attribute_header_id)&& ($attribute_header_id==$attribute_header_row->attribute_header_id)){
							$selected ='selected';
						}
					} else if(isset($attribute_header_id) && !is_numeric($attribute_header_id) ){
						if(isset($attribute_header_id) && ($attribute_header_id==$attribute_type_row->attribute_header_title)){
							$selected ='selected';
						}
					}
					...
					?>
					<option value="<?php echo $attribute_header_row->attribute_header_title;?>" <?php echo $selected;?>><?php echo $attribute_header_row->attribute_header_title;?></option>
				<?php
				}
				?>
				</select>
