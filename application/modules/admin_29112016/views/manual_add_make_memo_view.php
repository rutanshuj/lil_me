      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <div class="col-xs-12">
			...
			<div class="box box-info">
                ...
                <!-- form start -->
                <form method="post" action="<?php echo base_url('admin/out_on_memo/manual_add_make_memo');?>" onsubmit="return validateForm()"  name="step_third" id="step_third">
		...
		?>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
					  <input type="text" class="form-control" name="memo_date" style="width: 70% !important;" value="<?php echo $memo_date;?>" placeholder="YYYY-MM-DD" id="datepicker">
                      
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-2 control-label"  style="width: 30% !important;">Expiry Date*:</label>
                      <div class="col-sm-10">
					  <input type="text" class="form-control" name="expiry_date"id="expiry_date" style="width: 70% !important;" value="<?php echo $expiry_date;?>" placeholder="YYYY-MM-DD">
				  ...
				  <a href="<?php echo base_url('admin/out_on_memo/manual_add_select_product');?>" 
     class="btn btn-primary">Back</a>
				  
				  <input type="submit" class="btn btn-primary pull-right" id="submit" name="submit" value="Next">
