 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <div class="col-xs-12">
            ...
            <div class="col-xs-12">
			  ...
			  <form role="form" action="<?php echo base_url('admin/category/edit?id=').$category_id;?>" method="post"  enctype="multipart/form-data">
		...
		?>
				...
				<div><input type="text" name="category_name" id="category_name" value="<?php echo $category_name;?>">
				<input type="hidden" value="<?php echo $description;?>" name="description" id="description">
				</div>
				...
				<div>
				<img src="<?php echo base_url().$image_url?>" alt="<?php echo $category_name;?>" height="42" width="42">
             ...
             <div class="form-group">
				<div style="float: left;width: 160px;">Update Image :</div>
				<div>
			...
			<div class="form-group">
				...
				<input type="submit" class="btn btn-primary" id="submit" name="submit" value="Update Category" >
				</div>
