...
x[0].submit();
	 ...
	 // alert(JSON.stringify(product_id));
		...
		?>
				...
				<form action="<?php echo base_url('admin/out_on_memo/manual_add_select_product');?>" method="post" name="frm-example" id="frm-example">
               ...
               <table id="example"  class="display table table-bordered table-striped">
                    <thead>
                      <tr  class="table_th_border">
					    <th class="no-filter"><?php if(count($step_two_product)!="0"){?><input name="select_all" value="1" type="checkbox"><?php }?></th>
                        <th style="width:22%;text-align: center;"  >Stock Id</th>
                        <th style="width:22%;text-align: center;">Category</th>
                        <th style="width:22%;text-align: center;">Sub Category</th>
                        <th style="width:22%;text-align: center;">Last Updated</th>
					...
					<th></th>
						...
						<th class="subcategory" style="text-align: center;">Sub Category</th>
						<th class="no"></th>
...
<td><?php echo $step_two_product_rows->product_id;?></td>
                        ...
                        <td><?php echo $step_two_product_rows->category_name;?></td>
                        <td><?php echo $step_two_product_rows->subcategory_name;?></td>
				  ...
				  <a href="<?php echo base_url('admin/out_on_memo/manual_add');?>" class="btn btn-primary" style="float: right;
">Back</a>
					 </div>
