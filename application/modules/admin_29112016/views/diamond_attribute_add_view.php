      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
		   <div class="col-xs-12">
					...
					<a href="<?php echo base_url('admin/diamond_attribute');?>" class="btn btn-primary" > Attribute List</a></div>
					
					<div style="padding-bottom: 10px;"><a href="<?php echo base_url('admin/diamond_attribute/add');?>" class="btn btn-primary" style="border-style:groove solid double;border-color: black;border-width: 2px;border-radius: 6px"> Add New Attribute</a></div>
				</div>
            <div class="col-xs-12">
              <div class="box">
			  ...
			  <form role="form" action="<?php echo base_url('admin/diamond_attribute/add');?>" method="post"  enctype="multipart/form-data">
		...
		?>
				...
				<?php foreach($master_attribute_type as $attribute_type_row) {
					...
					?>
					<option <?php echo $selected;?> value="<?php echo $attribute_type_row->attribute_type_id;?>"><?php echo $attribute_type_row->attribute_type_title;?></option>
				<?php
				}
				?>
				</select></div>
				...
				<?php foreach($master_attribute_header as $attribute_header_row) {
					...
					?>
					<option <?php echo $selected;?> value="<?php echo $attribute_header_row->attribute_header_id;?>"><?php echo $attribute_header_row->attribute_header_title;?></option>
				<?php
				}
				?>
				</select>
				...
				<input type="number" value="<?php if(isset($sort_order)){echo $sort_order;}?>" name="sort_order" type="number"  min="0" >
