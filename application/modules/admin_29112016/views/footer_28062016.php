...
$('#expiry_date').datepicker({
	...
	<?php  if(($page=="home_page")||($page=="verify_user")||($page=="category")||($page=="sub_category")||($page=="diamond_attribute")||($page=="diamond_manage_stock")||($page=="out_on_memo")||($page=="verify_admin")||($page=="market_news")||($page=="attribute")||($page=="stock")||($page=="request_for_quote")||($page=="diamond_request_for_quote")||($page=="excel_uploader")||($page=="diamond_excel_uploader")){ ?> 
	<!-- DataTables -->
