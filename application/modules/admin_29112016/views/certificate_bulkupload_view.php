 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Bulk certificate image upload
            
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Bulk certificate image upload</li>
          </ol>
        </section>
	...
	document.getElementById("uploading").style = "visibility: hidden";	
		...
		function submitForm() {
            ...
            $.ajax({
              url: "<?php echo base_url('admin/bulk_certificate_image_upload/zipupload_diamond_certificate');?>",
              type: "POST",
              data: fd,
              processData: false, 
              contentType: false   
				...
				window.location = "<?php echo base_url('admin/bulk_certificate_image_upload');?>";
            });
            return false;
        }
		...
		document.getElementById('bulk_certificate_image_upload_page').style.pointerEvents = 'none';
		  ...
		  <div class="col-xs-12">
					...
					<a href="<?php echo base_url('admin/diamond_excel_uploader');?>" class="btn btn-primary" id="upload_excel_page">Upload Excel</a></div>
					...
					<div style="padding-bottom: 10px;"><a href="<?php echo base_url('admin/bulk_certificate_image_upload');?>" class="btn btn-primary" style="border-style:groove solid double;border-color: black;border-width: 2px;border-radius: 6px"  id="bulk_certificate_image_upload_page"> Bulk Certificate Image Upload</a></div>
				</div>
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Bulk certificate image upload</h3>
                </div>
                <div class="box-body">
		...
		?>
			...
			<!--<form action="<?php echo base_url().('admin/bulk_certificate_image_upload/zipupload_diamond_certificate');?>" method="POST" enctype="multipart/form-data" > !-->
            Select File To Upload:<br />
			<div style="float:left;"><input type="file" name="userfile" /></div>
