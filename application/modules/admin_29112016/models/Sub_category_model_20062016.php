...
class Sub_category_model extends CI_Model
{
	...
	function sub_category_name_validation($sub_category_id= false ,$subcategory_name= false,$id=false){
	...
	function sub_category($sub_category_id= false){
		...
		$this->db->select('product_subcategory.subcategory_id as subcategory_id, product_subcategory.subcategory_name as subcategory_name,product_subcategory.category_id as category_id,product_subcategory.description as description,product_category.category_name  as category_name ');
