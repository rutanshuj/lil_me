...
class User_model extends CI_Model
{
	...
	function user_favorites($id=false){
		$this->db->select('favorites.favourite_id as favourite_id, favorites.product_id as product_id, favorites.updated_on as updated_on ,product.product_name as product_name ,product.category_id as category_id ,product_category.category_name as category_name,product_images.image_id as image_id,product_images.image_url as image_url,product_images.image_thumbnail_url as image_thumbnail_url'); 
