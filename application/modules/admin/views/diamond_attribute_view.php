 ...
 <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/plugins/sweetalert-master/dist/sweetalert.css">
        ...
        <section class="content">
		  ...
		  <div class="col-xs-12">
					...
					<a href="<?php echo base_url('admin/diamond_attribute');?>" class="btn btn-primary" style="border-style:groove solid double;border-color: black;border-width: 2px;border-radius: 6px"> Attribute List</a></div>
		...
		?>
				...
				<?php if(count($attributes)!="0"){
					...
					swal({   title: "Are you sure to delete below attribute ?", 
					  ...
					  function(isConfirm){  
						  if (isConfirm) {  
							window.location = "<?php echo base_url('admin/diamond_attribute/diamond_attribute_delete?id=');?>"+attribute_id+"&headline="+headline;	
                  ...
                  <table id="example16" class="table table-bordered table-striped">
					...
					<?php if(count($attributes)!="0"){
                      ...
                      <tr>
						...
						if(is_numeric($active_rows->attribute_header_title)&&(isset($m_attribute_header[$active_rows->attribute_header_title]))){
							echo $m_attribute_header[$active_rows->attribute_header_title];
						} else {
                        ...
                        <td><?php
						if(is_numeric($active_rows->attribute_type_title)&&(isset($m_attribute_type[$active_rows->attribute_type_title]))){
							echo $m_attribute_type[$active_rows->attribute_type_title];
						} else {
						...
						<td><a href="<?php echo base_url('admin/diamond_attribute/edit?id=').$active_rows->attribute_id."&headline=".$active_rows->attribute_name?>"class="btn btn-primary" style="min-width: 52px;">Edit</a></td>
