      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <div class="col-xs-12">
					...
					<div style="float: left;padding-bottom: 10px;"><a href="<?php echo base_url('admin/sales/cancel');?>" style="border-style:groove solid double;border-color: black;border-width: 2px;border-radius: 6px"  class="btn btn-primary" id="">Cancel</a></div>
            ...
            <div class="col-xs-12">
			  ...
			  <form role="form" name="product_add" action="<?php echo base_url('admin/sales/cancel');?>" method="get" onsubmit="return validateForm()" >
...
function update_status(user_id,status,card_id,user_select_id){	
					...
					swal({   title: "Are you sure to change status as "+status+" ?", 
					  ...
					  function(isConfirm){  
						  if (isConfirm) {  
							window.location = "<?php echo base_url('admin/sales/card_up_date_status?user_id=');?>"+user_id+"&status="+status+"&card_id="+card_id+"&user_select_id="+user_select_id+"&page=cancel";	
