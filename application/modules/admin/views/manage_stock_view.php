    ...
    display: table-header-group;
        ...
        <section class="content">
		  ...
		  <div class="col-xs-12">
					...
					<a href="<?php echo base_url('admin/stock');?>" class="btn btn-primary" > List</a></div>
				
					<div style="padding-bottom: 10px;"><a href="<?php echo base_url('admin/stock/manage_stock');?>" class="btn btn-primary" style="border-style:groove solid double;border-color: black;border-width: 2px;border-radius: 6px"> Delete</a></div>
				</div>
		...
		?>
				...
				<?php //if(count($stock_list)!="0"){
                 ...
                 <!-- <table id="example1" class="table table-bordered table-striped"> -->
                    <thead>
                      <tr>
					   <th class="no-filter"><?php if(count($stock_list)!="0"){?><input name="select_all" value="1" type="checkbox"><?php }?></th>
					...
					<th></th>
						...
						<th class="subcategory">Gender</th>
