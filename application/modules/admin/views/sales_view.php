      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <div class="col-xs-12">
					...
					<div style="float: left;padding-right: 10px;padding-bottom: 10px;"><a href="<?php echo base_url('admin/sales');?>" style="border-style:groove solid double;border-color: black;border-width: 2px;border-radius: 6px" class="btn btn-primary"" class="btn btn-primary" id="">View by user</a></div>
            ...
            <div class="col-xs-12">
			  ...
			  <form role="form" name="product_add" action="<?php echo base_url('admin/sales');?>" method="get" onsubmit="return validateForm()" >
...
function update_status(user_id,status,card_id,user_select_id){	
					...
					swal({   title: "Are you sure to change status as "+status+" ?", 
					  ...
					  function(isConfirm){  
						  if (isConfirm) {  
							window.location = "<?php echo base_url('admin/sales/card_up_date_status?user_id=');?>"+user_id+"&status="+status+"&card_id="+card_id+"&user_select_id="+user_select_id+"&page=";	
			...
			<table id="example7" class="table table-bordered table-striped" >
					...
					<?php $num="0" ;foreach($sales_details[$t_id] as $sales_details_rows){$num++;?>
                      ...
                      <tr>
						...
						if(($sales_details_rows['cart_status']=="order placed")||($sales_details_rows['cart_status']=="dispatched")){
					?>
