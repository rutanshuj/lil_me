		...
		?>
          <div class="row">
			...
			<div class="box">
			  ...
			  <div class="box">
				...
				<?php if(count($active_admins)!="0"){
					...
					if((name=='Admin')||(name=='admin')){
						swal("Sorry, You cannot disable Admin account !");
					} else {
                  ...
                  <table id="example5" class="table table-bordered table-striped" >
					...
					<?php if(count($active_admins)!="0"){
                      ...
                      <tr>
						...
						<td>
						<input value="DISABLE"  type="button"  class="btn btn-primary" onClick="return admin_delete('<?php echo $active_rows->admin_id;?>','<?php echo $active_rows->username;?>','<?php echo $active_rows->email_id;?>')" />
						</td>
                      </tr>
                      <?php
						}
			  ...
			  <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Total Inactive Admins: <?php echo count($inactive_admins);?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
				
				<?php if(count($inactive_admins)!="0"){
					?>
					
					
					
					<script>
					function admin_enable(id,name,email){
					...
					swal({   title: "Are you sure to enable below user ?", 
					  ...
					  function(isConfirm){  
						  if (isConfirm) {  
							window.location = "<?php echo base_url('admin/verify_admin/admin_approve?id=');?>"+id+"&name="+name+"&email="+email+"&status=enable";	
                  ...
                  <table id="example5" class="table table-bordered table-striped" >
                    ...
                    <tbody>
					<?php if(count($inactive_admins)!="0"){
						foreach($inactive_admins as $inactive_admins_rows){
						?>
								
                     
                      <tr>
                        <td><?php echo $inactive_admins_rows->username;?></td>
                        <td><?php echo $inactive_admins_rows->firstname." ".$inactive_admins_rows->lastname;?></td>
                        <td><?php echo $inactive_admins_rows->email_id;?></td>
                        <td><?php echo $inactive_admins_rows->primary_phone_number;?></td>
                        <td><?php echo $inactive_admins_rows->city_name;?></td>
						<td>
						<input value="ENABLE"  type="button"  class="btn btn-primary" onClick="return admin_enable('<?php echo $inactive_admins_rows->admin_id;?>','<?php echo $inactive_admins_rows->username;?>','<?php echo $inactive_admins_rows->email_id;?>')" />
						</td>
                      </tr>
                      <?php
						}
