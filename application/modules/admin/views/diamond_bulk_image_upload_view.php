...
<script src="<?php echo base_url()."assets/ajax/libs/jquery/1.12.2/jquery.min.js";?>"></script>
	...
	document.getElementById("uploading").style = "visibility: hidden";	
		...
		function submitForm() {
            ...
            $.ajax({
              url: "<?php echo base_url('admin/diamond_bulk_image_upload/zipupload_diamond');?>",
              type: "POST",
              data: fd,
              processData: false, 
              contentType: false   
				...
				window.location = "<?php echo base_url('admin/diamond_bulk_image_upload');?>";
            });
            return false;
        }
		...
		document.getElementById('bulk_certificate_image_upload_page').style.pointerEvents = 'none';
		 ...
		 <div class="col-xs-12">
					...
					<div style="float: left;padding-right: 10px;padding-bottom: 10px;"><a href="<?php echo base_url('admin/diamond_bulk_image_upload');?>" class="btn btn-primary" style="border-style:groove solid double;border-color: black;border-width: 2px;border-radius: 6px"  id="bulk_image_upload_page"> Bulk Image Upload</a></div>
