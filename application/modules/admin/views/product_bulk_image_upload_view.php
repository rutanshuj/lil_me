 <!-- Content Wrapper. Contains page content -->
	...
	document.getElementById("uploading").style = "visibility: hidden";	
		...
		function submitForm() {
            ...
            $.ajax({
              url: "<?php echo base_url('admin/product_bulk_image_upload/zipupload_jewellery?is_mobile=0');?>",
              type: "POST",
              data: fd,
              processData: false, 
              contentType: false   
				...
				window.location = "<?php echo base_url('admin/product_bulk_image_upload');?>";
            });
            return false;
        }
		...
		document.getElementById('upload_excel_page').style.pointerEvents = 'none';
		  ...
		  <div class="col-xs-12">
					...
					<div style="padding-bottom: 10px;"><a href="<?php echo base_url('admin/product_bulk_image_upload');?>" class="btn btn-primary"style="border-style:groove solid double;border-color: black;border-width: 2px;border-radius: 6px" id="jewellery_bulk_image_upload_page"> Bulk Image Upload</a></div>
				</div>
            <div class="col-xs-12">
              <div class="box">
