		...
		?>
		  ...
		  -->
			   ...
			   <div class="form-group">
				<div  style="float: left;width: 160px;">Product Id</div>
				<div>
				<input type="input" name="product_id" id="product_id" value="<?php if(isset($product_name)){echo $product_name;}?>"></div>
		...
		/* 	if(count($category_list)>0){
			...
			//}
			   ...
			   <div class="form-group" style="padding-top: 10px;">
				...
				$selected="";
				if($gender==$gender_row->gender){
					$selected='selected';
				}
				
			echo "<option value=\"".$gender_row->gender."\" ".$selected.">".$gender_row->gender."</option>";		
