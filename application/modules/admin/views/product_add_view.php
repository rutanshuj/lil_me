      ...
      <div class="content-wrapper">
            ...
            <div class="col-xs-12">
			  ...
			  <script>
				  ...
				  function validateForm() {
						...
						var z = document.forms["product_add"]["gender"].value;
						if (x == null || x == "") {
						...
						if (z == null || z == "") {
							alert("Kindly select a gender for the product");
							document.forms["product_add"]["gender"].focus();
							return false;
						}
					}			  
			  </script>
		...
		?>
			...
			<div class="form-group">
				...
				<div>
				<input type="input" name="product_id" id="product_id">
				</div>			
...
">
			...
			//}
			   ...
			   <div class="form-group" style="padding-top: 10px;">
				<div  style="float: left;width: 160px;">Gender</div>
				<div> <select id="gender" name="gender" style="max-width: 137px;width: 137px;height: 30px;">
...
<?php 
			...
			echo "<option value=\"".$gender_row->gender."\" >".$gender_row->gender."</option>";		
