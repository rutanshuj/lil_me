      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <div class="col-xs-12">
					...
					<a href="<?php echo base_url('admin/catalogue');?>" class="btn btn-primary" style="border-style:groove solid double;border-color: black;border-width: 2px;border-radius: 6px"> Add</a></div>
		...
		<div style="float: left;width: 160px;">Pdf :</div>
		<div> <input type="file" name="userfile" id="userfile" accept="application/pdf"></div>		
		</div>
	   </div>
		...
		<div> <input type="file" name="userfile1" id="userfile1" accept="image/*"></div>		
		</div>
	   </div>
		<div class="box-body">	
		<div class="form-group">
		<div style="float: left;width: 160px;">Keyword's :</div>
		
		
		
		<div> <textarea rows="4" cols="50"  name="keywords" id="keywords"><?php if(isset($keywords)){echo $keywords;}?></textarea></div>		
		</div>
	   </div>
		<div class="box-body">	
		<div class="form-group">
		<div style="float: left;width: 160px;"></div>
		<div> <input type="submit" value="upload" name="upload" class="btn btn-primary"></div>		
		</div>
	   </div>
