...
function validate_select() {
		...
		if (z == null || z == "") {
			...
			alert(z);
			window.location.href = '<?php echo base_url("admin/product_diamond/edit?id=");?>'+z;			
			return false;
		}
	}
...
<script>
    ...
    .append('<option value="" selected>--select--</option>');		
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url('admin/product_diamond');?>/get_sub_category_ids",
			data: {                
	...
	function get_products(){
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Product Edit <a href="<?php echo base_url('admin/product_diamond/edit?id=').$product_id;?>">Back to product</a></h3>
                </div>
                <div class="box-body">
				<?php 
		...
		?>
			 ...
			 <div class="form-group">
				...
				<div>
							  <form role="form" name="product_add" action="<?php echo base_url('admin/product_diamond/image_edit/edit?id=').$product_id;?>" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
