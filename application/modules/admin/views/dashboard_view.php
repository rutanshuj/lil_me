            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                <div class="inner">
                   ...
                   Last Updated On<br>
                  <?php if(isset($products['last_updated_on'])){ echo $products['last_updated_on'];}?><br>
				  Number Of Stocks<br>
                  <?php if(isset($products['number_of_stocks'])){ echo $products['number_of_stocks'];}else { echo 0 ;}?>
                </div>
                <div class="icon">
                  <i class="ion ion-pie-graph"></i>
                </div>
                <a href="<?php echo base_url('admin/stock');?>" class="small-box-footer">Products </a>
              </div>
            </div><!-- ./col -->
			 <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-yellow">
                <div class="inner">
                  Order Received<br>
                  <?php if(isset($order_received)){ echo $order_received;}else { echo 0 ;}?><br>
				  Completed<br>
                  <?php if(isset($order_completed)){ echo $order_completed;}else { echo 0 ;}?>
                </div>
                <div class="icon">
                  <i class="ion ion-person-add"></i>
                </div>
                <a href="<?php echo base_url('admin/sales/order_placed');?>" class="small-box-footer">Sales </a>
              </div>
            </div><!-- ./col -->
				  ...
				  <div class="col-sm-12">
				   ...
				   <table id="example" class="table table-bordered table-striped" >
                    ...
                    <thead>
					  ...
					  <th class="select-filter" style="width: 20% !important;text-align: center;">User</th>
					  
					  <td  class="no-filter" style="width: 20% !important;text-align: center;"><b>Activity Time</b></td>
					  
					  <th class="select-filter" style="width: 20% !important;text-align: center;">Activity</th>
					  
					
					
					 <th class="select-filter" style="width: 20% !important;text-align: center;">Product name</th>
                    </thead>
					...
					<tfoot>
					<tr>
						<th class="width_20_persent" style="text-align: center;">User</th>
						<th class="width_20_persent">Activity Time</th>
						<th class="width_20_persent"style="text-align: center;">Activity</th>
						 <th class="width_20_persent"style="text-align: center;"></th>
