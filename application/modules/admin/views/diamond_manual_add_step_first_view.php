   ...
   var radios = document.getElementsByName("user_id");
	...
	alert("Please select at least one Username");	
     return false;
				...
				<form method="post" action="<?php echo base_url('admin/diamond_out_on_memo/manual_add');?>" onsubmit="return validateForm()"  name="step_first" id="step_first">
				<p><b>Select user to whom you want to send Memo</b></p>
