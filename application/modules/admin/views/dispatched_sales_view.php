      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <div class="col-xs-12">
					...
					<div style="float: left;padding-bottom: 10px;padding-right: 10px;"><a href="<?php echo base_url('admin/sales/dispatched');?>" class="btn btn-primary" id="" style="border-style:groove solid double;border-color: black;border-width: 2px;border-radius: 6px">Dispatched</a></div>
            ...
            <div class="col-xs-12">
			  ...
			  <form role="form" name="product_add" action="<?php echo base_url('admin/sales/dispatched');?>" method="get" onsubmit="return validateForm()" >
