      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navigation">
          <ul class="nav navbar-nav navbar-left">
		   ...
		   <li class="dropdown yamm-fw">
          <a href="<?php echo base_url('web/home/favorites/1')?>" class="dropdown-toggle" data-hover="dropdown">Favorites
          </a>
        </li>
        <li class="dropdown yamm-fw">
...
?>
  ...
  <div class="cartitem" id="<?php echo $cart_row['id'];?>"> 
    ...
    <div class="cart-data">
      ...
      <select class="size" name="size" onchange="sizeChange(<?php echo $cart_row['id'];?>,this.value)">
        <?php
